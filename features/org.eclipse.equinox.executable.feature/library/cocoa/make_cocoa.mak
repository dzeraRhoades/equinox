...
InventoryUnix.o: ../Inventory.h ../InventoryUnix.c
	$(CC) $(CFLAGS) -c ../InventoryUnix.c -o $@

$(EXEC): $(MAIN_OBJS) $(COMMON_OBJS)
	$(CC) $(LDFLAGS) -o $(EXEC) $(ARCHS) $(MAIN_OBJS) $(COMMON_OBJS) $(LIBS)

$(DLL): $(DLL_OBJS) $(COMMON_OBJS) $(LIB_INV_OBJS)
	$(CC) -bundle -o $(DLL) $(ARCHS) $(DLL_OBJS) $(COMMON_OBJS) $(LIBS) $(LIB_INV_OBJS)
...
install: all
	...
	cp -v ../libinventory/libinventory.dylib $(LIBRARY_OUTPUT_DIR)
	rm -f $(EXEC) $(OBJS)
