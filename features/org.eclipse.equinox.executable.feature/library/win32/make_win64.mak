...
LIB_INVENTORY_OBJS = InventoryWin.obj
...
DLL_LIBS = kernel32.lib user32.lib comctl32.lib gdi32.lib Advapi32.lib libcmt.lib version.lib \
	libvcruntime.lib libucrt.lib ole32.lib windowscodecs.lib ../libinventory/libinventory.lib
LFLAGS = /DYNAMICBASE /NXCOMPAT /HIGHENTROPYVA /RELEASE /NOLOGO -subsystem:windows -entry:wmainCRTStartup
CONSOLEFLAGS = /DYNAMICBASE /NXCOMPAT /HIGHENTROPYVA /INCREMENTAL:NO /RELEASE /NOLOGO -subsystem:console -entry:wmainCRTStartup
DLL_LFLAGS = /DYNAMICBASE /NXCOMPAT /HIGHENTROPYVA /INCREMENTAL:NO /PDB:NONE /RELEASE /NOLOGO  -dll /BASE:0x140000000 /DLL
RES	= $(PROGRAM_NAME).res
EXEC	= $(PROGRAM_OUTPUT)
CONSOLE = $(PROGRAM_NAME)c.exe
DLL    = $(PROGRAM_LIBRARY)
DEBUG  = #$(cdebug)
wcflags = -I.. -I..\libinventory -DDEFAULT_OS="\"$(DEFAULT_OS)\"" \
	-DDEFAULT_OS_ARCH="\"$(DEFAULT_OS_ARCH)\"" \
	-DDEFAULT_WS="\"$(DEFAULT_WS)\"" \
	-I"$(JAVA_HOME)\include" -I"$(JAVA_HOME)\include\win32" \
	$(cflags)

invflags = -I..\libinventory /c
...
InventoryWin.obj: ../Inventory.h ../InventoryWin.c
 	cl $(DEBUG) $(wcflags) $(cvarsmt)  /Fo$*.obj ../InventoryWin.c

inventoryFacade.obj: ../inventoryFacade.h ../inventoryFacade.c
	cl $(DEBUG) $(wcflags) $(cvarsmt) /Fo$*.obj ../inventoryFacade.c
...
$(DLL): $(DLL_OBJS) $(COMMON_OBJS) $(LIB_INVENTORY_OBJS)
    link $(DLL_LFLAGS) -out:$(PROGRAM_LIBRARY) $(DLL_OBJS) $(LIB_INVENTORY_OBJS) $(COMMON_OBJS) $(DLL_LIBS)
...
install: all
	...
	copy $(CONSOLE) $(OUTPUT_DIR)
	copy $(DLL) $(LAUNCHER_OUTPUT_DIR)
	copy ..\libinventory\libinventory.dll $(LAUNCHER_OUTPUT_DIR)
	del -f $(EXEC) $(CONSOLE) $(DLL) $(MAIN_OBJS) $(MAIN_CONSOLE_OBJS) $(LIB_INVENTORY_OBJS) $(DLL_OBJS) $(COMMON_OBJS) $(RES)
   
clean:
	del $(EXEC) $(DLL) $(MAIN_OBJS) $(MAIN_CONSOLE_OBJS) $(DLL_OBJS) $(LIB_INVENTORY_OBJS) $(COMMON_OBJS) $(RES)
